  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-md transition-transform duration-300 hover:scale-110 hover:bg-[#20ba5a] focus:outline-none focus:ring-2 focus:ring-[#25D366]/50"
