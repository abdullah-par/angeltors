...
export const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '220 80 50', // Defaulting to a nice blue HSL value matching #00379E
  ...
  coneSpread = 25,
  animated = false,
  colors = ['#00379e', '#3b82f6', '#93c5fd'], // Royal blue colors to match button theme
  fillOpacity = 0.15,
}) => {
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-[#00379e]/10 ${className}`}
      style={{
        background: backgroundColor,
        borderRadius: `${borderRadius}px`,
        transform: 'translate3d(0, 0, 0.01px)',
        boxShadow: 'rgba(0,37,64,0.04) 0 4px 10px, rgba(0,37,64,0.02) 0 1px 3px',
      }}
    >
